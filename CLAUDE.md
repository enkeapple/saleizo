...
Process basics (Implementation Protocol, Suspicion Protocol, evidence-based verification, question discipline): [.claude/rules/common/framework.md](./.claude/rules/common/framework.md). Domain glossary: [.claude/rules/common/document-domains.md](./.claude/rules/common/document-domains.md).
